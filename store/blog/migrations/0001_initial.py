...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=150, validators=[account.validators.validate_username], verbose_name='username')),
                ('email', models.EmailField(max_length=150, verbose_name='email')),
                ('password', models.CharField(max_length=150, validators=[account.validators.validate_password], verbose_name='password')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='post_setting', to='blog.post', verbose_name='post')),
            ],
            options={
